...
import {ISuperTokenFactory} from "https://github.com/superfluid-finance/protocol-monorepo/blob/remix-support-soda-machine/packages/ethereum-contracts/contracts/interfaces/superfluid/ISuperTokenFactory.sol";
...
contract Example {
    ...
    function step1_deploy() internal {
        ...
        _sodaMachine = address(
            new SodaMachine(
                _host,
                _cfa,
                _acceptedToken,
                ISuperToken(address(_sodaToken))
            )
        );
